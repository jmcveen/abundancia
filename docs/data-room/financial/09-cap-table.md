...
> *This document contains forward-looking statements based on current assumptions, market data, and management projections. Actual results may differ materially from those projected. The capitalization structure, distribution waterfall, and promote calculations described herein are subject to the final terms of the Company's Operating Agreement and subscription documents, and to review by securities counsel. Investors should consult legal counsel regarding the specific terms and conditions of their investment. All waterfall terms below are subject to final documentation.*

---

> **THE OFFERING IS PHASE 1.** The capitalization table and waterfall in this document are the Phase-1 offering terms — the economics investors are buying. Full-project (all phases) figures appear only where expressly labeled as context.
...
- [2. Capitalization Summary — The Offering (Phase 1)](#2-capitalization-summary--the-offering-phase-1)
- [3. Ownership Structure](#3-ownership-structure)
- [4. Class A Units (LP Investors)](#4-class-a-units-lp-investors)
- [5. Class B Units / GP-Manager Interest](#5-class-b-units--gp-manager-interest)
- [6. Distribution Waterfall](#6-distribution-waterfall)
- [7. Waterfall Modeling](#7-waterfall-modeling)
- [8. GP Compensation](#8-gp-compensation)
- [9. Follow-On Capital & Later Phases](#9-follow-on-capital--later-phases)
...
Abundancia Community LLC is a single manager-managed Delaware LLC with two classes of membership units — there are no series or subsidiary entities:
...
## 4. Class A Units (LP Investors)

### 4.1 Unit Terms (subject to final documentation)
...
## 5. Class B Units / GP-Manager Interest

### 5.1 GP Compensation Structure (subject to final documentation)
...
### 6.1 Waterfall Structure (Phase-1 Offering — subject to final documentation)

| Tier | Threshold | GP Promote | Description |
|------|-----------|-----------:|-------------|
| **Preferred Return & Return of Capital** | Until the 10% cumulative LP preferred is current and capital returned | 0% | 100% to the equity class — LP-class first (pref + capital before any promote) |
| **Tier 1** | LP IRR below 12% | 10% | First promote tier |
| **Tier 2** | LP IRR 12% – 15% | 20% | Second promote tier |
| **Tier 3** | LP IRR 15% – 18% | 30% | Third promote tier |
| **Tier 4** | LP IRR above 18% | 40% (uncapped) | Full promote tier |

*GP catch-up applies. Hold period: 10 years.*

### 6.2 Distribution Reserve

A **20% distribution reserve** is withheld from positive cash flows annually as a safety buffer and released in Year 10.

### 6.3 Waterfall Mechanics — Calculation Flow

```
Step 1: Determine distributable cash for the period
Step 2: Withhold 20% distribution reserve (annual safety buffer; released Year 10)
Step 3: Pay accrued 10% cumulative preferred return and return of capital
        (100% to the equity class — LP-class first)

Then, on remaining amounts (with GP catch-up):
  → Tier 1: 10% GP promote below 12% LP IRR
  → Tier 2: 20% GP promote in the 12–15% LP IRR band
  → Tier 3: 30% GP promote in the 15–18% LP IRR band
  → Tier 4: 40% GP promote above 18% LP IRR (uncapped)
```
...
### 8.1 Summary (subject to final documentation)
...
## 9. Follow-On Capital & Later Phases
...
|-----------|-----------|
| **Pre-Emptive Rights** | Existing Class A members expected to have pro-rata participation rights in new issuances [TO CONFIRM] |
| **Member Consent** | Consent thresholds for materially dilutive issuances [TO CONFIRM] |
| **Promote Integrity** | GP promote percentages fixed per the Operating Agreement |
...
### 12.1 Governance Rights (subject to final documentation)

| Right | Description |
|-------|------------|
| Major Matter Consent | Class A voting limited to major matters (e.g., sale of substantially all assets, change of Manager, material amendments) [TO CONFIRM thresholds] |
| Reporting | Periodic financial and operational reporting to members [TO CONFIRM cadence] |
| Tax Documents | Annual K-1 delivery |
| Manager | GP is the Manager of Abundancia Community LLC (manager-managed) |

### 12.2 Protective Provisions (subject to final documentation)

| Provision | Detail |
|-----------|--------|
| **10% Cumulative Preferred** | LP preferred return accrues before any GP promote; return of capital LP-class first |
...
*This capitalization table and distribution waterfall should be reviewed in conjunction with the Operating Agreement of Abundancia Community LLC and subscription documents for definitive terms. In the event of any conflict between this document and the Operating Agreement, the Operating Agreement shall govern. All terms are subject to final documentation and review by securities counsel. Investors should consult their own legal, tax, and financial advisors before making an investment decision.*

...
All analyses are stated as of **July 2026**, reflecting the current financial model, market conditions, and management's development plan. Comparable-transaction and cap-rate market data carry the dates noted therein.

### 1.4 Scope of Work

Five valuation methodologies are applied to triangulate a defensible value range:
...
| **Replacement Cost** | Calculates total cost to replicate land position + infrastructure + vertical construction | Establishes floor value and cost basis | Determining minimum defensible value | 15% |
...
| **Development Profit** | Total projected revenue less total projected costs less required developer return | Tests whether the project "pencils" | Validating residual land/entity value | 15% |

*Method weightings are management judgments [TO CONFIRM with valuation professional].*
...
Year-by-year DCF cash flows are anchored to the model timeline:

| Year | Milestone | Cash Flow Character |
|------|-----------|---------------------|
| 2027 | Groundbreaking; pre-revenue | Negative (Year-1 uses $12.87M against $14.07M sources) |
| 2028 | First revenue (hospitality, micro-villas, lots, SFR launch) | Ramp; lot revenue 2028–2029 totals $14,295,171 |
...
Terminal value is derived from stabilized recurring income (2032+ recurring revenue of ~$7–8M/yr from rentals, hospitality, and commercial). Stabilized NOI and the terminal cap rate applied are **[TO CONFIRM]** with the valuation refresh.
...
The comparable transaction method benchmarks Abundancia's land position against recent sales of development-stage land in the Austin MSA and Bastrop County corridors, with adjustments for location, size, entitlement status, infrastructure, access, and highest-and-best-use potential.

### 4.2 Comparable Transactions

*The land-transaction dataset and per-acre adjustments used in the prior draft are undergoing independent re-verification and are **[TO CONFIRM]**. Verified market context points:*

- Bastrop County median home price $340,977 / $187/SF (Redfin, May 2026); county population ~122,500, +2.5%/yr, +64% since 2010
- Corridor anchors driving land demand: SpaceX Starlink Bastrop (1.1M SF, 1,000+ jobs; 11M SF Gigasat filing), X HQ Bastrop, Boring Co., $1.4B Cedar Creek data center (FM 535), Tesla Giga (~16.5K employees; 5.2M SF Terafab filing), AUS expansion (~$4–5B)
...
A comparable-transaction value conclusion is **[TO CONFIRM]** pending re-verification of the transaction dataset and final land terms.
...
The replacement cost method calculates the total cost to replicate the Abundancia project at current market rates — land, infrastructure, vertical construction, soft costs, and financing carry. This establishes a cost-basis floor: "What would it cost a new entrant to build this from scratch?"

### 5.2 Project Cost Stack (per September 2026 financial model)
...
The income capitalization approach values the income-producing components (rental condos, event house, nature stays, commercial) by capitalizing stabilized Net Operating Income at market cap rates.

### 6.2 Stabilized Income Base (per model)

| Component | Detail |
|-----------|--------|
| Rental portfolio (136 units) | 1×6BR event house; 75 rental condos; 50 nature stays ($150/$275/$375 per night tiers + camping) — 10-yr rentals revenue $53,231,500 |
| Commercial (12 spaces / 30,000 SF) | 10-yr commercial revenue $11,820,840 |
| Stabilized recurring revenue (2032+) | ~$7–8M/yr |
| Stabilized NOI | [TO CONFIRM] |

### 6.3 Capitalization Rate Selection

Market cap-rate evidence (Austin multifamily, suburban commercial, lifestyle-community premiums) is being refreshed; the selected blended cap rate is **[TO CONFIRM]**. Wellness/lifestyle community benchmarks are drawn from the approved comparable set: **The Sanctuary; Whisper Valley (Manor, TX); Serenbe (GA — 1,200 acres, 750+ residents, wellness agrihood premiums)**.

### 6.4 Income Capitalization Value

The capitalized value of income assets plus the NPV of for-sale proceeds is **[TO CONFIRM]** pending confirmation of stabilized NOI, cap rate, and discount rate.
...
The development profit method works from projected total revenue, subtracting all development costs and a required developer profit margin, to arrive at a residual value. This directly tests whether the project "pencils."

### 7.2 Gross Development Value (per September 2026 model)
...
| Valuation Method | Indicated Value | Weight |
|-----------------|----------------|--------|
...
Prior indicated values and the prior concluded range were computed on superseded model figures (including a $435M revenue base and a $37.6M land basis) and have been withdrawn. The refreshed reconciliation will rest on: (a) the July 2026 model's revenue/expense/EBITDA base; (b) the modeled $6.5M land acquisition (scenario — subject to final terms); (c) verified market cap-rate and land-comp evidence; and (d) confirmed discount-rate assumptions. A concluded fair-market-value range is **[TO CONFIRM]**.
...
| Parameter | Election A | Election B |
|-----------|-----------|-----------|
| **Phase-1 Total Capitalization** | $15,939,072 | $15,939,072 |
| **Class A LP Equity** | $7,739,072 (93.93% of equity) | $3,739,072 (88.20% of equity) |
| **Secured Promissory Notes** | — | $4,000,000 (10%, subordinate to construction debt) |
| **GP Co-Investment** | $500,000 (6.07% of equity, pari passu with LP capital) | $500,000 (11.80% of equity, pari passu with LP capital) |
| **Phase-1 Debt** | $7,700,000 (8.5%, 10-yr fully amortizing; $1,173,539/yr service) | $7,700,000 (8.5%, 10-yr fully amortizing; $1,173,539/yr service) |
| **Security Type** | Class A Units of Abundancia Community LLC | Class A Units + Secured Promissory Notes |
| **Offering Exemption** | Regulation D Rule 506(c), accredited investors only (subject to review by securities counsel) | Same |
...
Pre-money component values (land position, entitlement progress, development rights/IP, team value) are being restated on the current land basis and model figures and are **[TO CONFIRM]**.

### 9.3 Valuation Build to Target Returns (Phase-1 Offering, from models)
...
| **$100K LP investment — total distributions** | — | $244,924 (net profit $144,924) | — | $365,470 (net profit $265,470) |

*LP capital is fully returned by Year 3 under both Elections. Distributions per the waterfalls in Document 09 (10% cumulative LP preferred; GP promote tiers of 10%/20%/30%/40% at 12%/15%/18% LP IRR hurdles with GP catch-up; 20% distribution reserve released Year 10) — subject to final documentation.*

---

## 10. Implied Value Metrics

### 10.1 Program Metrics (from model)
...
Comparisons are limited to the approved comparable set — **The Sanctuary; Whisper Valley (Manor, TX — ~7,500 planned zero-energy homes, geothermal, $300–750K, proving east-Austin sustainability demand); Serenbe (GA — 1,200 acres, 750+ residents, homes from ~$375K, wellness agrihood premiums)**. Per-unit and per-acre value comparisons against these communities are **[TO CONFIRM]** pending the valuation refresh.
...
### 11.1 Valuation Sensitivity

Enterprise-value sensitivities to pricing, absorption, construction costs, and discount rate are being re-run on the rebased model and are **[TO CONFIRM]**. Directional sensitivities (as relative swings on the base case) are presented in Document 08.

### 11.2 Scenario-Based Return Anchors (from model)

| Scenario | LP Outcome |
|----------|-----------|
| **Base — Election A (10-yr hold)** | 26.02% IRR / 2.449x |
| **Base — Election A (5-yr, interim)** | 20.07% IRR / 1.6515x |
| **Base — Election B (10-yr hold)** | 34.81% IRR / 3.655x |
| **Base — Election B (5-yr, interim)** | 28.04% IRR / 2.104x |
...
| Early lot revenue | $14,295,171 (2028–2029) |
...
2. No physical inspection of the property was conducted in connection with this analysis. Valuations are based on management-provided data, the July 2026 financial model, publicly available information, and third-party market research.
3. Comparable transaction data reflects publicly available information and may not capture all relevant deal terms; the land-comp dataset is undergoing re-verification [TO CONFIRM].
...
7. This report was prepared for the exclusive use of prospective investors evaluating the Phase-1 offering (total capitalization $15,939,072, identical under both Elections) and should not be used for any other purpose, including lending, regulatory compliance, or tax reporting. All offering terms are subject to final documentation and review by securities counsel.

---

## Confidentiality Notice

This Valuation Report and all information contained herein is strictly confidential and proprietary to Abundancia Community LLC. This document has been prepared solely for the use of authorized prospective investors and their professional advisors in connection with the evaluation of a potential investment in Abundancia Community LLC.

By accepting this document, the recipient agrees to:

1. Maintain the confidentiality of all information contained herein
2. Not reproduce, distribute, or disclose this document or its contents to any third party without the prior written consent of Abundancia Community LLC
...
*Cedar Creek, Texas*
*Manager: New Earth Development — Kelly Krezek, CEO*

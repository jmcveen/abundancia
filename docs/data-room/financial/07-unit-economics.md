...
Homes are positioned "from approximately $450/SF" (entry anchor). Blended realized pricing by type — never a single flat price across all homes:

| Unit Type | Blended Realized Pricing |
|-----------|--------------------------|
| Single-Family Homes | ~$566/SF |
| Condominiums | ~$400/SF |
| Tiny Homes | ~$416/SF (~$104K–$166K per home) |
...
|-----------|--------|
| **Unit Count** | 100 |
| **Mix** | 10×1BR (1,000 SF); 20×2BR (1,500 SF); 20×3BR (2,000 SF); 20×4BR (2,500 SF); 20×5BR (3,500 SF); 5×6BR (4,500 SF); 5×7BR (5,000 SF) |
...
| **Pricing** | From ~$450/SF (entry anchor); ~$566/SF blended realized per model |
| **Target Buyer** | Wellness-oriented primary residence and second-home buyers |
| **Comparable Context** | Austin $1M+ homes avg $423/SF (Texas Realtors 2025); Barton Creek ~$553–802/SF; West Lake Hills ~$756/SF |

### 2.2 Cost & Margin

Per-unit cost breakdowns (hard/soft/land/other allocations) are maintained in the financial model and are [TO CONFIRM] for publication. SFR deliveries are scheduled 2028–2031 (sales launch 2028; 30 homes 2029; 40 homes 2030; 30 estate homes 2031).

### 2.3 Positioning Rationale

SFR pricing at ~$566/SF blended realized sits between the Austin $1M+ average ($423/SF) and premium west-Austin submarkets (Barton Creek $553–802/SF; West Lake Hills ~$756/SF), supported by wellness real estate premiums of 10–25% (GWI) and the hempcrete/regenerative product differentiation.
...
| **Mix** | 16 studio (232 SF); 18×1BR (272 SF); 20×2BR (416 SF); 6 early-discount (416 SF) |
| **Pricing** | ~$416/SF (~$104K–$166K per home) |
| **Delivery** | First tiny homes deliver 2028 |
...
*Note: residential tiny homes/domes (rental) and nature-stay domes are separate rental products (Section 6) and are never blended with for-sale tiny home revenue.*
...
### 6.1 Portfolio Specification (126 units)

| Component | Count | Detail |
|-----------|-------|--------|
| 6BR Event House | 1 | 6,000 SF — Retreat Center revenue (with unique regenerative stays) |
| Rental Condos | 75 | 25×1BR / 25×2BR / 25×3BR (25 online 2029; 25 online 2031) |
...
*Revenue classification: Retreat Center revenue = 6BR event house + unique regenerative stays only. Residential rentals (tiny homes/domes) are tracked separately. Rental condos are tracked separately. Occupancy, ADR trajectory, and per-unit NOI schedules are maintained in the model [TO CONFIRM].*
...
10-year commercial revenue: **$7,102,227** — tracked separately from residential, rental, and retreat streams.
...
|-----------|-------------------|----------------|-------------|
| SFR Homes | From ~$450/SF; ~$566/SF blended realized | Austin $1M+ avg $423/SF; Barton Creek $553–802/SF; West Lake Hills ~$756/SF | Premium wellness product below top west-Austin submarkets |
| Condominiums | ~$400/SF | Austin $1M+ avg $423/SF | At/below Austin premium average |
| Tiny Homes | ~$416/SF (~$104K–$166K) | Austin median home $452K | Absolute-price affordability entry |
| Estate Lots | ~$229K avg | Bastrop County median home $340,977 | Custom-home land within amenitized community |
| Nature Stays | $150–$375/nt | US glamping 12.8% CAGR | Experience-led hospitality |
...
| Lever | Application |
|-------|-------------|
| Early-discount tiny homes | 6 units allocated to early community members |
| Entry anchor ("from ~$450/SF") | Accessible headline with per-type blended realization above anchor |
...
*This unit economics model should be reviewed alongside Document 06 (10-Year Financial Projections) for timeline context and Document 08 (Sensitivity Analysis) for stress testing. Cost estimates reflect the July 2026 financial model and are subject to market conditions.*

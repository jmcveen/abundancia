        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-white/30 leading-relaxed max-w-xs font-body font-light">
              Regenerative living in harmony with nature. A 376-acre community in Bastrop County proving that profitable development and ecological regeneration amplify each other.
            </p>
          </div>

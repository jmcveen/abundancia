...
const MILESTONES = [
  {
    ...
    items: [
      ...
      '$15.9M capital raise in progress',
  ...
  },
  {
    ...
    detail: 'Land acquisition is the single largest capital deployment event. The $6.5M purchase price includes the full 380-acre parcel. Simultaneously, we initiate the critical planning workstreams: hydrology studies to map water resources and retention pond locations, environmental compliance review, master site planning with Symbiosis TX to define conservation corridors, building envelopes, and infrastructure routes. The Delaware LLC entity is formed, and the MUD petition is filed to unlock tax-exempt bond financing for infrastructure.',
  ...
  },
  {
    ...
    items: [
      ...
      '60 regen villas, domes & glamping stays for guest capacity',
      'Model home + 60 micro villas in hempcrete',
  ...
  },
  {
    ...
    items: [
      ...
      'First sales: 60 micro villas ($8.9M) + 80 lots ($10.8M)',
  ...
  },
  {
    ...
    status: 'upcoming' as const,
    items: [
      'Education Center & school built',
      '100 single-family homes delivered',
      '20 additional residential lots released',
      'Food forests and permaculture reach scale',
    ],
    detail: 'Phase 2 builds the community\'s core amenity infrastructure and scales residential density. The Creation Hub - co-working spaces, artist studios, recording studio, makerspace - becomes the creative heart of the community. Condominium construction begins, adding 275 units at more accessible price points (~$275K-$350K). Commercial tenants move in, creating the walkable village center with grocery, restaurants, and retail. This phase is largely self-funded from Phase 1 revenues and MUD bond reimbursements.',
  ...
  },
  {
    ...
    status: 'upcoming' as const,
    items: [
      '275 condominiums delivered (200 for sale, 75 rental)',
      '11 commercial village spaces open',
      'Sacred Temple Complex & 10-acre lake activated',

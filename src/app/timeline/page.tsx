...
const MILESTONES = [
  ...
  },
  {
    ...
    detail: 'Land acquisition is the single largest capital deployment event. The $6.5M purchase price includes the full 376-acre parcel. Simultaneously, we initiate the critical planning workstreams: hydrology studies to map water resources and retention pond locations, environmental compliance review, master site planning with Symbiosis TX to define conservation corridors, building envelopes, and infrastructure routes. The Delaware LLC entity is formed, and the MUD petition is filed to unlock tax-exempt bond financing for infrastructure.',

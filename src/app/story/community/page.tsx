...
const COMMUNITY_SPACES = [
  ...
  { image: '/images/website/19-pyramid-ceremony-space.jpeg', name: 'Regenerative Agriculture', detail: 'Designed to help the community become 50-75% food self-sufficient through more than 20 acres of regenerative agriculture and greenhouses that can grow all types of food in any weather conditions.', link: '/story/regeneration' },
]

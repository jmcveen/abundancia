...
const PUBLIC_SPACES = [
  ...
  { image: '/images/website/74-wellness-center.png', name: 'Wellness Center', detail: 'A restorative destination for holistic wellness experiences, recovery, and daily self-care. Designed to support vitality through calming spaces, therapeutic offerings, and programs that nurture body, mind, and spirit.', link: '/story/regeneration' },

...
const PETALS = [
  {
    ...
    color: 'bg-green-500',
    detail: 'Abundancia preserves 70-75% of its 150+ acres as native Lost Pines ecosystem, wildlife corridors, and restored habitat. Development is clustered into pods that minimize land disturbance while maximizing connection to nature. Every resident lives within a 2-minute walk of preserved wilderness, food forests, or restored waterways.',
...
const REGEN_FEATURES = [
  {
    ...
    detail: 'The property sits within the Lost Pines — an isolated pocket of loblolly pines 100 miles west of the main pine belt. After the devastating 2011 Bastrop wildfire, ecological restoration is both an environmental imperative and a community identity. Abundancia designates 70-75% of its acreage as permanently conserved land, actively restoring native habitat for the endangered Houston toad and dozens of other species.',

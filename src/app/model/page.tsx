...
const UNIT_DETAILS: Record<string, string> = {
  ...
  'Multifamily': 'Target buyer: young families, couples, and individuals (28-45, HHI $80K-$120K) seeking community-oriented living at attainable price points. 275 condominium condo units averaging 986 SF each. Multifamily represents the highest unit count and the bulk of residential revenue. Buildings feature shared amenities (rooftop gardens, communal kitchens, play areas), hempcrete construction throughout, and solar-standard energy. This product type enables density that supports commercial viability while maintaining the regenerative ethos.',
      ...
      <section className="bg-primary-800 py-20 md:py-28">
        <div className="section-container text-center">
          <FadeIn>
            ...
            <p className="font-accent text-xs uppercase tracking-[0.14em] text-secondary-300 mb-10">
              {INVESTMENT_DISCLAIMER}
            </p>
          </FadeIn>

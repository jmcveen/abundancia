...
const REVENUE_STREAM_DETAILS: Record<string, string> = {
  ...
  'Rental Income': 'Rental income totals $43.6M over 10 years from 75 rental multifamily condos and 50 special rental units (unique stays) owned by the development, plus 60 STR units owned by investors. The annual target by year 5 is $5.5M. Guest accommodations include 50 special regenerative units that are development-owned and 60 owned by STR investors. This is a recurring revenue stream that continues beyond the 10-year model and forms the backbone of the retreat and event center. Risk factors: short-term rental regulation changes (mitigated by Bastrop County\'s permissive STR policies), occupancy rate assumptions.',
...
const UNIT_DETAILS: Record<string, string> = {
  ...
  'Special Rental': '50 special rental units — unique stays including regenerative tiny homes and domes designed for the retreat and short-term rental market. These development-owned units, along with 60 STR investor-owned units, form the guest accommodation backbone of Abundancia\'s retreat and event center. By year 5, the annual rental target is $5.5M.',
...
const USE_OF_FUNDS_DETAILS: Record<string, string> = {
  'Land Acquisition': 'The land acquisition budget of $3,945,000 (32%) covers the purchase of 376 acres in Cedar Creek, Texas — approximately 30 minutes southeast of downtown Austin along SH-71. Due diligence costs include environmental assessments, ALTA survey, hydrology study and water resource assessment, Houston toad habitat compliance study, geotechnical borings, and legal/closing costs. The property includes an existing farmhouse, guest house, and outbuildings that will be repurposed for Phase 1 retreat operations.',

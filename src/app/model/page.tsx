...
const USE_OF_FUNDS_DETAILS: Record<string, string> = {
  'Land Acquisition': 'The land acquisition budget of $3,945,000 (32%) covers the purchase of 376 acres in Bastrop County, Texas - approximately 30 minutes from downtown Austin. Due diligence costs include environmental assessments, ALTA survey, hydrology study and water resource assessment, habitat compliance study, geotechnical borings, and legal/closing costs. The property includes existing structures that will be repurposed for Phase 1 retreat operations.',
